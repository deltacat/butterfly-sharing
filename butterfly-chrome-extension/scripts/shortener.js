var Shortener = function(engine) {

	var shortenEngine = engine;
	
	this.setEngine = function(newEngine) {
		shortenEngine = newEngine;
	}
	
	this.shortenUrl = function shortenUrl(url, func)
	{
		switch(shortenEngine)
		{
			case "is.gd":
